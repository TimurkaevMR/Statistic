...
public final class HomeViewModel: HomeViewModelProtocol {
    ...
    public var frequentVisitors: [UserDTO] = []
    public var demographicStats: [Grade: GendersValue] = [:]
    public var dailyVisits: [(date: Int, count: Int)] = []
    public var subscribers: [(date: Int, count: Int)] = []
    public var unsubscribers: [(date: Int, count: Int)] = []
    
    public init(usersViewModel: UsersViewModelProtocol,
